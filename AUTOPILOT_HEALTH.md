...
- `ok` GitHub claimer scheduler: github_bounty_claim_report.md is fresh (7 minutes old).
- `ok` GitHub submitter scheduler: github_bounty_submission_report.md is fresh (7 minutes old).
- `degraded` TaskBounty scout scheduler: taskbounty_report.md is stale (76 minutes old); dispatch sent.
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (270 minutes old); dispatch sent.
