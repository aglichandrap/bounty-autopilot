...
- `ok` Bounty scout scheduler: bounty_worker_queue.md is fresh (33 minutes old).
- `degraded` GitHub claimer scheduler: github_bounty_claim_report.md is stale (119 minutes old); dispatch sent.
- `ok` GitHub submitter scheduler: github_bounty_submission_report.md is fresh (2 minutes old).
- `degraded` TaskBounty scout scheduler: taskbounty_report.md is stale (59 minutes old); dispatch sent.
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (120 minutes old); dispatch sent.
