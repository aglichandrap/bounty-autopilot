...
- `ok` Bounty scout scheduler: bounty_worker_queue.md is fresh (0 minutes old).
- `degraded` GitHub claimer scheduler: github_bounty_claim_report.md is stale (76 minutes old); dispatch sent.
- `degraded` GitHub submitter scheduler: github_bounty_submission_report.md is stale (76 minutes old); dispatch sent.
- `degraded` TaskBounty scout scheduler: taskbounty_report.md is stale (79 minutes old); dispatch sent.
...
- `ok` Candidate feeds: GitHub candidates: 6; TaskBounty candidates: 4.
