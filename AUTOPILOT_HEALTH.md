...
- `degraded` Bounty scout scheduler: bounty_worker_queue.md is stale (101 minutes old); dispatch sent.
- `degraded` GitHub claimer scheduler: github_bounty_claim_report.md is stale (167 minutes old); dispatch sent.
- `degraded` GitHub submitter scheduler: github_bounty_submission_report.md is stale (168 minutes old); dispatch sent.
- `ok` TaskBounty scout scheduler: taskbounty_report.md is fresh (32 minutes old).
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (148 minutes old); dispatch sent.
...
- `ok` Candidate feeds: GitHub candidates: 3; TaskBounty candidates: 1.
