...
- `degraded` Bounty scout scheduler: bounty_worker_queue.md is stale (93 minutes old); dispatch sent.
...
- `ok` TaskBounty scout scheduler: taskbounty_report.md is fresh (13 minutes old).
