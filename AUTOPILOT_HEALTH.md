...
- `degraded` Bounty scout scheduler: bounty_worker_queue.md is stale (104 minutes old); dispatch sent.
- `degraded` GitHub claimer scheduler: github_bounty_claim_report.md is stale (94 minutes old); dispatch sent.
- `degraded` GitHub submitter scheduler: github_bounty_submission_report.md is stale (102 minutes old); dispatch sent.
- `degraded` TaskBounty scout scheduler: taskbounty_report.md is stale (65 minutes old); dispatch sent.
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (103 minutes old); dispatch sent.
