...
- `ok` GitHub claimer scheduler: github_bounty_claim_report.md is fresh (45 minutes old).
- `degraded` GitHub submitter scheduler: github_bounty_submission_report.md is stale (52 minutes old); dispatch sent.
- `degraded` TaskBounty scout scheduler: taskbounty_report.md is stale (55 minutes old); dispatch sent.
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (55 minutes old); dispatch sent.
