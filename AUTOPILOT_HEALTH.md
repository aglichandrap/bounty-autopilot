...
- `ok` GitHub submitter scheduler: github_bounty_submission_report.md is fresh (0 minutes old).
- `ok` TaskBounty scout scheduler: taskbounty_report.md is fresh (35 minutes old).
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (151 minutes old); dispatch sent.
