...
- `ok` Bounty scout scheduler: bounty_worker_queue.md is fresh (23 minutes old).
- `degraded` GitHub claimer scheduler: github_bounty_claim_report.md is stale (58 minutes old); dispatch sent.
