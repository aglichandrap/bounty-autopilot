...
- `ok` Bounty scout scheduler: bounty_worker_queue.md is fresh (35 minutes old).
...
- `degraded` TaskBounty scout scheduler: taskbounty_report.md is stale (49 minutes old); dispatch sent.
- `degraded` TaskBounty worker scheduler: taskbounty_worker_report.md is stale (87 minutes old); dispatch sent.
