...
Last built: 2026-05-20 11:03 UTC
...
## Queue Item 1: [SUGGESTION] 1.12.1 clients don't get primary display properly for resolution/refresh rate options
...
- Score: 73
- Work priority: 83.0
- Match reason: paid/bounty wording, visible amount, coding scope, low discussion
...
## Queue Item 2: site: verify Stripe live-mode flip on Vercel + end-to-end smoke test

- Issue: https://github.com/Nolpak14/agorio/issues/72
- Repository: https://github.com/Nolpak14/agorio
- Amount hint: $1
- Score: 73
- Work priority: -31.9
- Match reason: paid/bounty wording, visible amount, coding scope, low discussion
