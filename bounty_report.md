...
## 3. decentralization (off-chain): cross-authority handoff issue/present/accept path

- Score: 39
- Amount hint: amount not obvious
- Issue: https://github.com/cenetex/signal/issues/479
- Repository: https://github.com/cenetex/signal
- Updated: 2026-05-18T04:36:25Z
- Why it matched: mentions bounty/reward, low discussion volume
- Next action: inspect repo, confirm bounty rules, reproduce issue, submit a focused PR only if the fix is real.
...
- Score: 39
- Amount hint: Bounty: 0
- Issue: https://github.com/ZecHub/zechub/issues/1567
- Repository: https://github.com/ZecHub/zechub
- Updated: 2026-05-18T02:12:06Z
- Why it matched: mentions bounty/reward, low discussion volume
- Next action: inspect repo, confirm bounty rules, reproduce issue, submit a focused PR only if the fix is real.

## 8. BGL PR bounty hunt ($10000 overall budget)
