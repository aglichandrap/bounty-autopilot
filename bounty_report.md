...
## 1. [ Bounty $5k ] [ Config ] Validate sandbox resource limit config — config-to-sandbox boundary
...
## 6. Linux miner dry-run on Windows reports CPU Unknown without platform warning
