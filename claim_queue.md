...
### Bug: findTaskByIssueUrl URL normalisation regex strips entire path findTaskByIssueUrl in src/lib/attempts/core.ts (line 70) tries to normalise an incoming GitHub issue URL with this regex
