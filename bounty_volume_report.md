...
- Score: 65
- Amount: $7, $7200
- Issue: https://github.com/ClankerNation/OpenAgents/issues/69
- Repository: https://github.com/ClankerNation/OpenAgents
- Reason: paid/bounty wording, visible amount, coding scope

## [ Bounty $3k ] [ Runtime ] Enforce deterministic cleanup for temporary run files — file runtime
...
## clawrtc mine --dry-run is documented but rejected by CLI
...
## [ Assembly ] Fix parse_tls_record version parsing byte order bug

- Score: 65
- Amount: $1
- Issue: https://github.com/UnsafeLabs/Bounty-Hunters/issues/1
...
- Score: 55
- Amount: $1000
- Issue: https://github.com/Dasharo/dasharo-issues/issues/1273
- Repository: https://github.com/Dasharo/dasharo-issues
- Reason: paid/bounty wording, visible amount

## [ Bounty $3k ] [ Solidity ] Fix PrizeSplit doesn't handle case where winner is contract without receive
...
## [ Bounty $4k ] [ Data ] Escape spreadsheet formulas in CSV exports — reporting downloads
...
## [ Bounty $1k ] [ SDK ] Fix crypto.ts doesn't support secp256k1 key recovery from signature

- Score: 65
- Amount: $1, $1700
- Issue: https://github.com/ClankerNation/OpenAgents/issues/136
- Repository: https://github.com/ClankerNation/OpenAgents
- Reason: paid/bounty wording, visible amount, coding scope
